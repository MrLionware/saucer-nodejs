...
#include <stdbool.h>
    ...
    typedef struct saucer_handle saucer_window;

    enum SAUCER_WINDOW_DECORATION
    {
    ...
    SAUCER_EXPORT void saucer_window_set_fullscreen(saucer_window *, bool enabled);
    ...
    SAUCER_EXPORT void saucer_window_off(saucer_window *, SAUCER_WINDOW_EVENT event, size_t id);
    SAUCER_EXPORT void saucer_window_off_all(saucer_window *, SAUCER_WINDOW_EVENT event);

    SAUCER_EXPORT void saucer_window_native(saucer_window *, size_t idx, void *result, size_t *size);
