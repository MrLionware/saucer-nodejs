...
#include "window.h"
    ...
    SAUCER_EXPORT void saucer_scheme_response_add_header(saucer_scheme_response *, const char *header,
                                                         const char *value);
    SAUCER_EXPORT void saucer_scheme_response_append_header(saucer_scheme_response *, const char *header,
                                                            const char *value);
    ...
    SAUCER_EXPORT void saucer_scheme_executor_accept(saucer_scheme_executor *, saucer_scheme_response *response);
