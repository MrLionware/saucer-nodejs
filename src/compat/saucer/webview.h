...
#include <stdbool.h>
    ...
    SAUCER_EXPORT void saucer_webview_options_set_attributes(saucer_webview_options *, bool value);
    SAUCER_EXPORT void saucer_webview_options_set_persistent_cookies(saucer_webview_options *, bool value);
    SAUCER_EXPORT void saucer_webview_options_set_hardware_acceleration(saucer_webview_options *, bool value);
    SAUCER_EXPORT void saucer_webview_options_set_storage_path(saucer_webview_options *, const char *value);
    SAUCER_EXPORT void saucer_webview_options_set_user_agent(saucer_webview_options *, const char *value);
    SAUCER_EXPORT void saucer_webview_options_append_browser_flag(saucer_webview_options *, const char *value);
    ...
    typedef bool (*saucer_on_message)(struct saucer_handle *, const char *);
    ...
    SAUCER_EXPORT void saucer_webview_set_force_dark(saucer_webview *, bool enabled);
    ...
    SAUCER_EXPORT void saucer_webview_set_url_str(saucer_webview *, const char *url);
    SAUCER_EXPORT void saucer_webview_set_html(saucer_webview *, const char *html);
    ...
    SAUCER_EXPORT void saucer_webview_embed(saucer_webview *, const char *path, saucer_stash *content, const char *mime);
    ...
    SAUCER_EXPORT void saucer_webview_unembed(saucer_webview *, const char *path);
    ...
    SAUCER_EXPORT void saucer_webview_uninject(saucer_webview *, size_t id);
    ...
    SAUCER_EXPORT void saucer_webview_off(saucer_webview *, SAUCER_WEB_EVENT event, size_t id);
    SAUCER_EXPORT void saucer_webview_off_all(saucer_webview *, SAUCER_WEB_EVENT event);
    ...
    SAUCER_EXPORT void saucer_webview_register_scheme(const char *name);
    SAUCER_EXPORT void saucer_webview_native(saucer_webview *, size_t idx, void *result, size_t *size);
